<template>
	<view class="p-2" style="background-color: #ffffff;">
				...
				<view class="uni-uploader__files">
					<block v-for="(image,index) in imageList" :key="index">
						<view class="uni-uploader__file position-relative">
							...
							<view class="position-absolute p-2 rounded" style="top: 0%;right: 0%;padding: 0 15rpx;
								background-color: rgba(0, 0, 0, 0.5);" @click.stop="deleteImage(index)">
